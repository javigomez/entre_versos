import type { ImageChoiceChallenge, SingleChoiceChallenge } from './schemas';
export type ChallengeAnswerResult = 'invalid' | 'retry' | 'completed';
export function evaluateChallengeAnswer(challenge: SingleChoiceChallenge | ImageChoiceChallenge, optionId: string): ChallengeAnswerResult {
